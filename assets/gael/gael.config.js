...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', () => { gaelInstallOfficialStyle(); gaelInstallFilterSync(); setInterval(gaelEnhanceDock, 300); setInterval(gaelPatchSpeechPlacement, 300); });
} else {
